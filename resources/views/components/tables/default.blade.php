                                ...
                                <p class="font-semibold capitalize">{{ $resource->name }}</p>
                                    ...
                                    @elseif ($column == 'status')
                                        <span @class([
                                            ...
                                            'text-green-700 bg-green-100 bg-green-700text-green-100' =>
                                                $resource->$column == 'Terminé',
                                            ' text-gray-700 bg-gray-100text-gray-100 bg-gray-700' =>
                                                $resource->$column == 'En cours',
                                            ' text-gray-700 bg-yellow-100text-gray-100bg-yellow-700' =>
                                        ...
                                        @foreach ($mactions as $action => $title)
                                            ...
                                            @elseif ($action == 'edit')
                                                <a href="{{ route($type . '.edit', [$type => $resource->id]) }}"
                                                    class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-main rounded-lgtext-main focus:outline-none focus:shadow-outline-gray"
                                                    aria-label="Edit">
